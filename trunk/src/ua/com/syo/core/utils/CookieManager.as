...
package ua.com.syo.core.utils {
	...
	public class CookieManager {
		 ...
		 *	@throws	Error 		An error is thrown if cookies is disabled in browser
		 */
		public static function store(name:String, value:String, expires:Date = null, path:String = null, domain:String = null, secure:Boolean = false):void {
			if (!cookiesEnabled) {
				throw new Error("Cookies is disabled. Check if ExternalInterface is available and cookies is enabled.");
			}
		 ...
		 *	@param	secure		The secure cookie indicates if cookie will accessed only via HTTPS
		 */
		public static function remove(name:String, path:String = null, domain:String = null, secure:Boolean = false):void {
